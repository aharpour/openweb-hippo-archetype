        ...
        if ("edit".equals(mode)) {
            IDialogFactory dialogFactory = new IDialogFactory() {
                ...
                public AbstractDialog<String> createDialog() {
                    ...
                    //TODO: Retrieve locale and pass ass it to the new LinkPickerDialog constructor
                    final Locale locale = SelectionUtils.getLocale(SelectionUtils.getNode(docbaseModel));
            ...
            add(new ClearableDialogLink("docbase", displayModel, dialogFactory, getDialogService()) {
                ...
                public void onClear() {
                    ...
                    try {
                        node.setProperty(HippoNodeType.HIPPO_DOCBASE, node.getSession().getRootNode().getIdentifier());
            ...
            protected String load() {
                ...
                try {
                    if (node != null && node.hasProperty(HippoNodeType.HIPPO_DOCBASE)) {
                        ...
                        return node.getSession().getNodeByIdentifier(docbaseUUID).getPath();
                    }
